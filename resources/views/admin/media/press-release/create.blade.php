  ...
  <div class="row" style="margin-bottom:30px;">
	...
	<div class="row">
		<div class="col-lg-12 col-xs-12">
			<form id="bulletin" role="form" action="{{ route('storePressRelease') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
        	<h2>Press Release Create Form</h2>
        	<hr>
          <div class="form-group">
            <label for="title">Press Release Title</label>
            <input name="title" type="text" class="form-control" id="title" placeholder="Press Release Title" required>
          </div>
          <div class="form-group">
            <label for="press_file">Press Release File (Only PDF)</label>
            <input name="press_file" type="file" id="press_file" accept=".pdf" required>
            <div>
        ...
        <div class="box-footer">
          <button type="submit" class="btn btn-primary">Press Release Add</button>
        </div>
      </form>
		</div>
	</div>
