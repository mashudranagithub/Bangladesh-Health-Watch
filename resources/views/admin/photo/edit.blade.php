              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="photo_type" class="form-control" id="photo_type" required>
                    <option value="gallery" @if($photo->photo_type == "gallery")selected @endif>Gallery</option>
                    <option value="other" @if($photo->photo_type == "other")selected @endif>Others</option>
                  </select>
                </div>
                <div class="form-group">

                  @if($photo)
                    <img style="max-width: 300px;" src="{{ url('front/assets/images/photo/'.$photo->photo) }}" alt="Gallery Photo"> <br> <br>
                  @endif
